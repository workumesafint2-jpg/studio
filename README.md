...
1. GitHub ገጽህ ላይ ሂድና **Settings** (ከላይ በቀኝ በኩል) ግባ።
2. ወደታች ወርደህ በስተግራ በኩል **Developer settings** የሚለውን ተጫን።
3. **Personal access tokens** -> **Tokens (classic)** ግባ።
4. **Generate new token** (classic) የሚለውን ተጫን።
5. ለቶክኑ ስም ስጠው (ለምሳሌ: `worku-token`) እና ቀኑን `No expiration` አድርገው።
6. **repo** የሚለውን ሳጥን አብራ (Check አድርግ)።
7. **Generate token** በለውና የሚመጣልህን ረጅም ኮድ (ለምሳሌ: `ghp_...`) ኮፒ አድርገህ ያዘው።
...
- **Zero-Cost Storage**: ያለ ክፍያ ዘዴ ፋይሎችን በ Base64 መጫን።
- **Performance Analysis**: በየቀኑ የሚገቡ መረጃዎችን በማነጻጸር የሚሰራ ግራፍ።
